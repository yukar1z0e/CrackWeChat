...
// ChangeParams方法
function ChangeParams(targetClassMethod) {
...
setTimeout(function () { 
    ...
    Java.perform(function () {
        ...
        // ChangeParams("com.tencent.mars.xlog.Xlog.getLogLevel");
        // ChangeParams("com.tencent.voip.mars.xlog.Xlog.getLogLevel"); 

        // ChangeRetval("com.tencent.mars.xlog.Xlog.getLogLevel");
        // ChangeRetval("com.tencent.voip.mars.xlog.Xlog.getLogLevel");        

        trace("com.tencent.mars.xlog.Xlog.logwrite2");
        
        trace("com.tencent.mars.mm.MMLogic.getIPsString");
...
// frida -R -f com.tencent.mm -l hookMMLogic.js -o MMLogic.txt
