...
setTimeout(function () { 
    ...
    Java.perform(function () {
        ...
        // trace("exports:xlogger_VPrint");
        // trace("android.os.Debug");
        trace("android.os.Debug.isDebuggerConnected");
        ChangeRetval("android.os.Debug.isDebuggerConnected");
    });
}, 0);

// frida -R -n com.tencent.mm -l hookDebug.js -o tmp.txt
