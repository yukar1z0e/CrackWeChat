...
//                    getInfo();
//                    queryCheck();
//                    searchPhone(phoneNumber[0]);
//                    backContactInfoUI();
//
//                    getInfo();
//                    queryCheck();
//                    searchPhone(phoneNumber[1]);
//                    backContactInfoUI();

                    searchInfoAll(phoneNumber[0]);
                    searchInfoAll(phoneNumber[1]);
    ...
    public void searchInfoAll(final String phoneNumber){
        killXposedTest();
