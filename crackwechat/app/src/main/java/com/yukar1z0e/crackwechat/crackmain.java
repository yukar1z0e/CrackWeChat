package com.yukar0z0e.crackwechat;
...
public class crackmain implements IXposedHookLoadPackage {
    ...
    public void queryCheck() {
        ...
        final Class<?> FTSBaseUIClass = findClass("com.tencent.mm.plugin.fts.ui.FTSBaseUI", lpparam.classLoader);
         ...
         我jio得这是一个bug
         query的值应该填手机号der
         然后wx做一个判断，用长度判断它是不是一个手机号，理论上是00位
         然鹅实际上填00位也阔以der，不过00位就不阔以
         */
        ...
        findAndHookMethod(FTSAddFriendUIClass, "Mf", String.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                ...
                queryField.set(param.thisObject, "00000000000");
            }
        });
    }
                ...
                */
                findAndHookMethod(FTSAddFriendUIClass, "Mf", String.class, new XC_MethodHook() {
                    ...
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        queryField.set(param.thisObject, "00000000000");
                        //String queryVal0=(String) queryField.get(param.thisObject);
                        //Log.d("CrackMain","query--->"+queryVal0);
