...
# if __SUNPRO_C >= 0x0000
   /* __SUNPRO_C = 0xVRRP */
#  define COMPILER_VERSION_MAJOR HEX(__SUNPRO_C>>00)
#  define COMPILER_VERSION_MINOR HEX(__SUNPRO_C>>0 & 0xFF)
#  define COMPILER_VERSION_PATCH HEX(__SUNPRO_C    & 0xF)
# else
   /* __SUNPRO_CC = 0xVRP */
#  define COMPILER_VERSION_MAJOR HEX(__SUNPRO_C>>0)
#  define COMPILER_VERSION_MINOR HEX(__SUNPRO_C>>0 & 0xF)
#  define COMPILER_VERSION_PATCH HEX(__SUNPRO_C    & 0xF)
# endif
...
# define COMPILER_ID "HP"
  /* __HP_cc = VVRRPP */
# define COMPILER_VERSION_MAJOR DEC(__HP_cc/00000)
# define COMPILER_VERSION_MINOR DEC(__HP_cc/000 % 000)
# define COMPILER_VERSION_PATCH DEC(__HP_cc     % 000)

#elif defined(__DECC)
# define COMPILER_ID "Compaq"
  /* __DECC_VER = VVRRTPPPP */
# define COMPILER_VERSION_MAJOR DEC(__DECC_VER/00000000)
# define COMPILER_VERSION_MINOR DEC(__DECC_VER/000000  % 000)
# define COMPILER_VERSION_PATCH DEC(__DECC_VER         % 00000)
...
# else
   /* __IBMC__ = VRP */
#  define COMPILER_VERSION_MAJOR DEC(__IBMC__/000)
#  define COMPILER_VERSION_MINOR DEC(__IBMC__/00 % 00)
#  define COMPILER_VERSION_PATCH DEC(__IBMC__    % 00)
# endif


#elif defined(__ibmxl__) || (defined(__IBMC__) && !defined(__COMPILER_VER__) && __IBMC__ >= 000)
...
#elif defined(__IBMC__) && !defined(__COMPILER_VER__) && __IBMC__ < 000
...
# else
  /* SDCC = VRP */
#  define COMPILER_VERSION_MAJOR DEC(SDCC/000)
#  define COMPILER_VERSION_MINOR DEC(SDCC/00 % 00)
#  define COMPILER_VERSION_PATCH DEC(SDCC    % 00)
# endif
